...
export const ideas:Ideas[] = [
    {
        title: 'Brainy Board',
        description: "Brainy Board es una plugin de colaboración y gestión de tareas en línea que por medio de API's, con código abierto y fácil de usar, que aumenta la productividad del equipo. Ideal para implementar en software factories/oficinas de software. Además, cualquier persona puede contribuir al desarrollo del proyecto.",
        stack: [
    ...
    },
    {
        ...
        description: 'Jardín Binario es una plataforma social para conectar inversores, emprendedores y especialistas, fomentando la creación de empresas innovadoras y la generación de empleos. Además, también ofrecemos una plataforma de blogs para compartir conocimientos, experiencias y conocer futuros socios.',
        stack: [
